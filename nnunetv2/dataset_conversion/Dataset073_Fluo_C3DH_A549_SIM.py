...
if __name__ == '__main__':
    ...
    train_source = 'media/fabian/nnUNet_raw/Dataset036_Glom'
    test_source = 'media/fabian/nnUNet_raw/Dataset036_Glom'
    ...
    splits = []
    splits.append(
        {'train': [i for i in caseids if i.startswith('002_')], 'val': [i for i in caseids if i.startswith('003_')]}
    )
    splits.append(
        {'train': [i for i in caseids if i.startswith('003_')], 'val': [i for i in caseids if i.startswith('002_')]}
    )
